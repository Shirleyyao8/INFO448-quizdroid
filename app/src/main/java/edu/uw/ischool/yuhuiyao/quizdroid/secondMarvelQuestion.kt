...
class secondMarvelQuestion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_second_marvel_question)
        ...
        submitButton.setOnClickListener{
            ...
            if (selectedRadioButtonId != -1) {
                ...
                val secondMathQuestionIntent = Intent(this, secondMarvelAnswer::class.java)

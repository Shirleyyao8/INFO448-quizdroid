...
class firstPhysicsAnswer : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_first_physics_answer)
        ...
        val correctAnswer = "Newton" // Set the correct answer here.
        ...
        nextButton.setOnClickListener {
            val firstMathAnswerIntent = Intent(this, secondPhysicsQuestion::class.java)

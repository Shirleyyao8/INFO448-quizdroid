...
class secondPhysicsAnswer : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_second_physics_answer)
        ...
        val correctAnswer = "9.8 m/s²" // Set the correct answer here.

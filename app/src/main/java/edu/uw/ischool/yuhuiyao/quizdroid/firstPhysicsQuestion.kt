...
class firstPhysicsQuestion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_first_physics_question)
        ...
        submitButton.setOnClickListener{
            ...
            if (selectedRadioButtonId != -1) {
                ...
                val firstMathQuestionIntent = Intent(this, firstPhysicsAnswer::class.java)
